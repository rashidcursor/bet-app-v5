...
function getProxyList() {
  // ✅ Complete proxy list - all proxies integrated for automatic failover
  // No env variables needed - all hardcoded in codebase
  const proxyList = [
    // Group 1: yeyccztb credentials (18 proxies)
    ...
    // Group 2: xzskxfzx credentials (20 proxies)
    ...
    // Group 3: henduccz credentials (19 proxies)
    ...
    // Group 4: klcnllsb credentials (90 proxies) - NEW
  ...
  console.log(`📋 [ProxyRotator] Using hardcoded proxy list (${proxyList.length} proxies)`);
